    ...
    return (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 sm:p-6 overflow-y-auto bg-black/50 backdrop-blur-sm transition-all duration-300">
            ...
            >
                ...
                <div className="h-1.5 w-full bg-gradient-to-r from-[#1718FE] via-[#3538ff] to-[#60a5fa] flex-shrink-0" />
                ...
                <div className="sticky top-0 z-20 bg-white/95 backdrop-blur-md px-8 py-5 border-b border-[#edf2f7] flex items-center justify-between flex-shrink-0">
                    <div>
                        <div className="flex items-center gap-2.5">
                            <span className="w-2.5 h-2.5 rounded-full bg-[#1718FE] shadow-sm shadow-[#1718FE]/50"></span>
                    ...
                    <button
                        type="button"
                        onClick={close}
                        className="w-10 h-10 rounded-2xl bg-[#f1f5f9] hover:bg-blue-50 text-[#64748b] hover:text-[#1718FE] flex items-center justify-center transition-colors text-xl font-medium"
                    >
                        ✕
                    </button>
                </div>
                ...
                >
                    <form onSubmit={handleSubmit(onSubmit)} id="blog-form" className="space-y-6">
                        ...
                        <div className="bg-[#f8fafc] rounded-[24px] p-6 border border-[#e5e7eb] space-y-5">
                            <div className="flex items-center justify-between">
                                <div className="flex items-center gap-2">
                                    <span className="w-7 h-7 rounded-xl bg-[#1718FE] text-white text-xs flex items-center justify-center font-bold shadow-sm shadow-[#1718FE]/30">1</span>
                                    <h3 className="text-base font-bold text-[#0f172a]">Basic Information</h3>
                                </div>
                                <span className="text-xs font-semibold text-[#1718FE] uppercase tracking-wider bg-blue-50 px-2.5 py-1 rounded-full border border-blue-100">Required Info</span>
                            </div>
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
                                ...
                                <div className="md:col-span-2">
                                    ...
                                    <input
                                        ...
                                        className="w-full h-11 rounded-xl border border-[#dbe2ea] px-4 text-sm text-[#0f172a] bg-white outline-none focus:border-[#1718FE] focus:ring-1 focus:ring-[#1718FE] transition"
                                    />
                                ...
                                <div className="md:col-span-2">
                                    ...
                                    <div className="relative flex items-center">
                                        ...
                                        <input
                                            ...
                                            className="w-full h-11 rounded-xl border border-[#dbe2ea] pl-16 pr-4 text-sm text-[#0f172a] bg-white outline-none focus:border-[#1718FE] focus:ring-1 focus:ring-[#1718FE] transition"
                                        />
                                    </div>
                        ...
                        <div className="bg-[#f8fafc] rounded-[24px] p-6 border border-[#e5e7eb] space-y-4">
                            <div className="flex items-center justify-between">
                                <div className="flex items-center gap-2">
                                    <span className="w-7 h-7 rounded-xl bg-[#1718FE] text-white text-xs flex items-center justify-center font-bold shadow-sm shadow-[#1718FE]/30">2</span>
                                    <h3 className="text-base font-bold text-[#0f172a]">Cover / Banner Image</h3>
                                </div>
                                <span className="text-xs font-semibold text-[#1718FE] uppercase tracking-wider bg-blue-50 px-2.5 py-1 rounded-full border border-blue-100">Media</span>
                            </div>
                        ...
                        <div className="bg-[#f8fafc] rounded-[24px] p-6 border border-[#e5e7eb] space-y-5">
                            <div className="flex items-center justify-between">
                                <div className="flex items-center gap-2">
                                    <span className="w-7 h-7 rounded-xl bg-[#1718FE] text-white text-xs flex items-center justify-center font-bold shadow-sm shadow-[#1718FE]/30">3</span>
                                    <h3 className="text-base font-bold text-[#0f172a]">Blog Content</h3>
                                </div>
                                <span className="text-xs font-semibold text-[#1718FE] uppercase tracking-wider bg-blue-50 px-2.5 py-1 rounded-full border border-blue-100">Rich Text</span>
                            </div>
                        ...
                        <div className="bg-[#f8fafc] rounded-[24px] p-6 border border-[#e5e7eb] space-y-5">
                            <div className="flex items-center justify-between">
                                <div className="flex items-center gap-2">
                                    <span className="w-7 h-7 rounded-xl bg-gradient-to-r from-[#1718FE] to-[#3b82f6] text-white text-xs flex items-center justify-center font-bold shadow-sm shadow-[#1718FE]/30">4</span>
                                    <h3 className="text-base font-bold text-[#0f172a]">SEO & Meta Configuration</h3>
                                </div>
                                <span className="text-xs px-2.5 py-1 rounded-full bg-blue-50 text-[#1718FE] font-semibold border border-blue-200">Search Engine Optimization</span>
                            </div>
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
                                ...
                                <div className="md:col-span-2">
                                    ...
                                    <textarea
                                        ...
                                        className="w-full rounded-xl border border-[#dbe2ea] p-3 text-sm text-[#0f172a] bg-white outline-none focus:border-[#1718FE] focus:ring-1 focus:ring-[#1718FE] transition resize-none"
                                    />
                                </div>
                                ...
                                <div className="md:col-span-2">
                                    ...
                                    <textarea
                                        ...
                                        className="w-full rounded-xl border border-[#dbe2ea] p-3 font-mono text-xs text-[#0f172a] bg-white outline-none focus:border-[#1718FE] focus:ring-1 focus:ring-[#1718FE] transition resize-none"
                                    />
                                </div>
                            </div>
                        </div>
                ...
                <div className="sticky bottom-0 z-20 bg-white/95 backdrop-blur-md px-8 py-5 border-t border-[#edf2f7] flex items-center justify-end gap-3.5 flex-shrink-0">
                    ...
                    <button
                        type="submit"
                        form="blog-form"
                        className="px-8 h-12 rounded-2xl bg-[#1718FE] hover:bg-[#3538ff] text-white text-sm font-semibold transition shadow-md shadow-[#1718FE]/25 hover:shadow-lg hover:shadow-[#1718FE]/35 flex items-center gap-2"
                    >
